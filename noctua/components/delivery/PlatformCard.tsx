...
export function PlatformCard({
  ...
  return (
    <motion.div
      ...
      className="bg-canvas border border-line rounded-xl p-6 cursor-pointer transition-all"
    >
      ...
      <div className="space-y-2">
        <div className="flex items-center justify-between">
          <span className="text-ink-3 text-sm">Pedidos pendientes</span>
          <span className="text-xl font-bold" style={{ color }}>{pendingCount}</span>
        </div>

        {lastOrderTime && (
          <div className="flex items-center justify-between">
            <span className="text-ink-3 text-sm">Último pedido</span>
