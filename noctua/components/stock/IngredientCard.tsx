...
export const IngredientCard = ({ ingredient, index }: IngredientCardProps) => (
  <motion.div
    ...
    className="bg-canvas border border-line rounded-xl p-4 hover:border-line-strong transition-all"
  >
    <div className="flex items-start justify-between mb-3">
      <div>
        <h3 className="text-ink font-semibold text-sm">{ingredient.name}</h3>
        <p className="text-ink-3 text-xs">{ingredient.category}</p>
      </div>
